...
class SinglePricingBoxFooter extends Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
    ...
    render() {
        return (
            <div className='row'>
                {foolData.singlePricingDataFooter.map(v => <div className="col-md-4 mb-30"
                                                                data-aos="zoom-in"
                                                                key={v.id}
...
export default SinglePricingBoxFooter;